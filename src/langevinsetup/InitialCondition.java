...
public class InitialCondition {
    ...
    // Adding 3/25/2015. We'll let the user define initial positions.  The 
    // initial coordinate will always refer to the position of Site 0 in
    // the box.  If the user doesn't provide enough ICs, then the rest of the
    // molecules are assigned randomly.  If they provide too many, then we 
    // ignore the last few.
    ...
    /* ***************** GET AND SET THE NUMBER DIRECTLY ****************/
    ...
    /* ********** GET AND SET THE NUMBER IN TERMS OF CONCENTRATION *******/
    // volume in nm^3
    ...
    // Return boolean indicating if we're using random positions
    public boolean usingRandomInitialPositions(){
        return randomIC;
    }
