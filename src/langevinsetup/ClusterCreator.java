...
public class ClusterCreator extends JFrame implements ActionListener {
    ...
    private boolean checkInput(){
        ...
        try{
            ...
            if(row < 0){
                ok = false;
                helpersetup.PopUp.error("Number of rows must be non-negative.");
            }
        ...
        try{
            ...
            if(column < 0){
                ok = false;
                helpersetup.PopUp.error("Number of columns must be non-negative.");
            }
        } catch(NumberFormatException nfe){
            ok = false;
        ...
        try{
            ...
            if(space <= 0){
                ok = false;
                helpersetup.PopUp.error("Spacing must be positive.");
            }
        } catch(NumberFormatException nfe){
            ok = false;
