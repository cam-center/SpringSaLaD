...
public class EditTransitionReactionsTablePanel extends JPanel {
    
    public EditTransitionReactionsTablePanel(Global g, Simulation simulation){
        this.setLayout(new BorderLayout());
        
        JTable table = new JTable(new EditTransitionReactionsTableModel(g, simulation));
