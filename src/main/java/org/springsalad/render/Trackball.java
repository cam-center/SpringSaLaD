...
/*
 * Ported from VCell (virtualcell/vcell), org.springsalad.render.Trackball, also MIT licensed.
 * Changed here: repackaged only.
 */
/**
 ...
 * @return org.springsalad.render.Camera
 */
...
public void setRotation(double angleRadX, double angleRadY, double angleRadZ) {
	org.springsalad.render.Vect3d rotationAngles = new org.springsalad.render.Vect3d(angleRadX,angleRadY,angleRadZ);

	org.springsalad.render.Matrix3d rotationMatrix = new org.springsalad.render.Matrix3d();
	rotationMatrix.setCosineRotation(rotationAngles);

	org.springsalad.render.Matrix3d invRotationMatrix = new org.springsalad.render.Matrix3d();
